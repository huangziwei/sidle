//! The on-screen keyboard. [`open`] and [`close`] set one property each on
//! [`SERVICE`]; [`height`] states how much of the screen it takes.
...
pub const CLIENT: &str = "com.sidle.picker";
