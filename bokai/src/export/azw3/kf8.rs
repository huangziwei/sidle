...
impl Kf8Builder {
    ...
    pub(super) fn build_text_records(&mut self) -> io::Result<()> {
        ...
        fn compress_record(chunk: &[u8]) -> Vec<u8> {
            let mut record = crate::formats::mobi::palmdoc::compress(chunk);
    ...
    pub(super) fn apply_trailing_byte_sequences(&mut self) {
        ...
        let tbs_entries: Vec<crate::formats::mobi::tbs::TbsEntry> = self
            .ncx_entries
            .iter()
            .enumerate()
            .map(|(i, e)| crate::formats::mobi::tbs::TbsEntry {
                index: i as u32,
                start: e.pos as u64,
        ...
        let tbs_data = crate::formats::mobi::tbs::build_tbs_for_records(&tbs_entries, &lengths);
