...
//!
//! The EPUB analog of [`crate::kfx::toc_repair`]. Where the KFX side rewrites
...
//! two is richer, so one repair fixes the Sidle reader and the derived KFX both.

use std::collections::HashSet;
use std::io;

use crate::epub::edit::{EpubPackage, escape_attr, escape_text};
use crate::epub::{OpfData, parse_nav_landmarks, parse_opf, parse_opf_guide};
...
fn free_id(opf: &OpfData, preferred: &str) -> String {
    ...
    (2..)
        ...
        .unwrap_or_else(|| format!("{preferred}-sidle"))
}
