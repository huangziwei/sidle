...
fn cached(slot: &'static OnceLock<HashMap<u64, i32>>, build: fn() -> HashMap<u64, i32>) -> &'static HashMap<u64, i32> {
...
pub fn val_dc_yuv() -> &'static HashMap<u64, i32> {
    ...
    cached(&SLOT, || {
        hbin(&[
            ("10", 0), ("001", 1), ("00001", 2), ("0001", 3),
            ("11", 4), ("010", 5), ("00000", 6), ("011", 7),
        ])
    })
}
...
pub fn num_cbphp(idx: usize) -> &'static HashMap<u64, i32> {
    ...
    match idx {
        0 => cached(&SLOT0, || hbin(&[
            ("1", 0), ("01", 1), ("001", 2), ("0000", 3), ("0001", 4),
        ])),
        1 => cached(&SLOT1, || hbin(&[
            ("1", 0), ("000", 1), ("001", 2), ("010", 3), ("011", 4),
        ])),
...
pub fn num_blkcbphp2(idx: usize) -> &'static HashMap<u64, i32> {
    ...
    match idx {
        0 => cached(&SLOT0, || hbin(&[
            ("010", 0), ("00000", 1), ("0010", 2), ("00001", 3),
            ("00010", 4), ("1", 5), ("011", 6), ("00011", 7), ("0011", 8),
        ])),
        1 => cached(&SLOT1, || hbin(&[
            ("1", 0), ("001", 1), ("010", 2), ("0001", 3),
            ("000001", 4), ("011", 5), ("00001", 6),
            ("0000000", 7), ("0000001", 8),
        ])),
...
pub fn first_index(idx: usize) -> &'static HashMap<u64, i32> {
    ...
    match idx {
        0 => cached(&SLOT0, || hbin(&[
            ("00001", 0), ("000001", 1), ("0000000", 2), ("0000001", 3),
            ("00100", 4), ("010", 5), ("00101", 6), ("1", 7),
            ("00110", 8), ("0001", 9), ("00111", 10), ("011", 11),
        ])),
        1 => cached(&SLOT1, || hbin(&[
            ("0010", 0), ("00010", 1), ("000000", 2), ("000001", 3),
            ("0011", 4), ("010", 5), ("00011", 6), ("11", 7),
            ("011", 8), ("100", 9), ("00001", 10), ("101", 11),
        ])),
        2 => cached(&SLOT2, || hbin(&[
            ("11", 0), ("001", 1), ("0000000", 2), ("0000001", 3),
            ("00001", 4), ("010", 5), ("0000010", 6), ("011", 7),
            ("100", 8), ("101", 9), ("0000011", 10), ("0001", 11),
        ])),
        3 => cached(&SLOT3, || hbin(&[
            ("001", 0), ("11", 1), ("0000000", 2), ("00001", 3),
            ("00010", 4), ("010", 5), ("0000001", 6), ("011", 7),
            ("00011", 8), ("100", 9), ("000001", 10), ("101", 11),
        ])),
        4 => cached(&SLOT4, || hbin(&[
            ("010", 0), ("1", 1), ("0000001", 2), ("0001", 3),
            ("0000010", 4), ("011", 5), ("00000000", 6), ("0010", 7),
            ("0000011", 8), ("0011", 9), ("00000001", 10), ("00001", 11),
        ])),
...
pub fn index_a(idx: usize) -> &'static HashMap<u64, i32> {
    ...
    match idx {
        0 => cached(&SLOT0, || hbin(&[
            ("1", 0), ("00000", 1), ("001", 2), ("00001", 3),
            ("01", 4), ("0001", 5),
        ])),
        1 => cached(&SLOT1, || hbin(&[
            ("01", 0), ("0000", 1), ("10", 2), ("0001", 3),
            ("11", 4), ("001", 5),
        ])),
        2 => cached(&SLOT2, || hbin(&[
            ("0000", 0), ("0001", 1), ("01", 2), ("10", 3),
            ("11", 4), ("001", 5),
        ])),
        3 => cached(&SLOT3, || hbin(&[
            ("00000", 0), ("00001", 1), ("01", 2), ("1", 3),
            ("0001", 4), ("001", 5),
        ])),
        _ => panic!("index_a {idx}"),
    }
...
pub fn index_b() -> &'static HashMap<u64, i32> {
    static SLOT: OnceLock<HashMap<u64, i32>> = OnceLock::new();
    cached(&SLOT, || hbin(&[("0", 0), ("10", 2), ("110", 1), ("111", 3)]))
}
...
pub fn run_value(max_run: usize) -> &'static HashMap<u64, i32> {
    ...
    match max_run {
        ...
        4 => cached(&SLOT4, || hbin(&[("1", 1), ("01", 2), ("001", 3), ("000", 4)])),
...
pub fn abs_level_index(idx: usize) -> &'static HashMap<u64, i32> {
    ...
    match idx {
        0 => cached(&SLOT0, || hbin(&[
            ("01", 0), ("10", 1), ("11", 2), ("001", 3),
            ("0001", 4), ("00000", 5), ("00001", 6),
        ])),
        1 => cached(&SLOT1, || hbin(&[
            ("1", 0), ("01", 1), ("001", 2), ("0001", 3),
            ("00001", 4), ("000000", 5), ("000001", 6),
        ])),
